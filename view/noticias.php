...
<div class="fondo">
    ...
    <!--Aca se muestra la noticia-->
        <div class="noticia">
          <img src="../assets/img/noticia-1.jpg" alt="">
          <div class="detalles">
            <h3>Llega la E-SIM</h3>
            <hr>
        ...
        <div class="noticia">
          <img src="../assets/img/noticia-2.jpg" alt="">
          <div class="detalles">
            <h3>De la mano de SUMA móvil: Smobi lanza su nuevo servicio de telefonía móvil en Chile</h3>
            <hr>
        ...
        <div class="noticia">
          <img src="../assets/img/noticia-3.jpeg" alt="">
          <div class="detalles">
            <h3>Smobi ingresa al mercado nacional como una OMV</h3>
            <hr>
            <p>por Adminweb | Noticias, Smobi</p>
            <br>
            <a class="info" href="noticia.php">Mas informacion</a>
        ...
        <div class="noticia">
          ...
          <div class="detalles">
            <h3>Compromiso con el futuro de la telefonía</h3>
            <hr>
        ...
        <div class="noticia">
          <img src="../assets/img/noticia-4.jpg" alt="">
          <div class="detalles">
            <h3>Tecnología 5G</h3>
            <hr>
            <p>Por Adminweb | Noticias, Técnologia</p>
        ...
        <div class="noticia">
          <img src="../assets/img/noticia-6.jpg" alt="">
          <div class="detalles">
            <h3>Nuevas empresas de telefonía móvil</h3>
            <hr>
            <p>Por Adminweb | Noticias, Smobi</p>
            <br>
            <a class="info" href="noticia.php">Mas informacion</a>
